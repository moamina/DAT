 ...
 * @generated
 */
public class RetrieveNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.RetrieveNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public RetrieveNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Retrieve_3049, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new RetrieveLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RetrieveLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RetrieveLabelFigure() {
			this.setText("Retrieve");
		}
