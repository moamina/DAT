 ...
 * @generated
 */
public class RealTimeNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.RealTimeNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public RealTimeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new RealTimeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RealTimeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RealTimeLabelFigure() {
			this.setText("RealTime");
		}
