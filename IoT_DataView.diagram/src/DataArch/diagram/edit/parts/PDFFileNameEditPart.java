 ...
 * @generated
 */
public class PDFFileNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.PDFFileNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public PDFFileNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.PDFFile_3006, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new PDFFileLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PDFFileLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PDFFileLabelFigure() {
			this.setText("PDFFile");
		}
