 ...
 * @generated
 */
public class EDINameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.EDINameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public EDINameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.EDI_3015, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new EDILabelFigure();
	}

	/**
	 * @generated
	 */
	public class EDILabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EDILabelFigure() {
			this.setText("EDI");
		}
