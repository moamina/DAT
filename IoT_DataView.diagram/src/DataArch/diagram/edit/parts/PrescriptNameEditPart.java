 ...
 * @generated
 */
public class PrescriptNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.PrescriptNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public PrescriptNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PrescriptLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PrescriptLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PrescriptLabelFigure() {
			this.setText("Prescript");
		}
