 ...
 * @generated
 */
public class CleaningNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.CleaningNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public CleaningNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new CleaningLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CleaningLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CleaningLabelFigure() {
