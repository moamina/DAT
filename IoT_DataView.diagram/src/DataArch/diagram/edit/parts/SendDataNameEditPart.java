 ...
 * @generated
 */
public class SendDataNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.SendDataNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public SendDataNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.SendData_3054, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new SendDataLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SendDataLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SendDataLabelFigure() {
			this.setText("SendData");
		}
