 ...
 * @generated
 */
public class JSONNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.JSONNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public JSONNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.JSON_3010, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new JSONLabelFigure();
	}

	/**
	 * @generated
	 */
	public class JSONLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public JSONLabelFigure() {
			this.setText("JSON");
		}
