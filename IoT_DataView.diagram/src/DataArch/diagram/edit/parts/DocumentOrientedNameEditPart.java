 ...
 * @generated
 */
public class DocumentOrientedNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.DocumentOrientedNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public DocumentOrientedNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.DocumentOriented_3020, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new DocumentOrientedLabelFigure();
	}

	/**
	 * @generated
	 */
	public class DocumentOrientedLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public DocumentOrientedLabelFigure() {
			this.setText("DocumentOriented");
		}
