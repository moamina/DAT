 ...
 * @generated
 */
public class APINameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.APINameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public APINameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.API_3036, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new APILabelFigure();
	}

	/**
	 * @generated
	 */
	public class APILabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public APILabelFigure() {
			this.setText("API");
		}
