 ...
 * @generated
 */
public class CompressNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.CompressNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public CompressNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Compress_3040, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new CompressLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CompressLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CompressLabelFigure() {
			this.setText("Compress");
		}
