 ...
 * @generated
 */
public class FilterNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.FilterNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public FilterNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Filter_3031, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new FilterLabelFigure();
	}

	/**
	 * @generated
	 */
	public class FilterLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public FilterLabelFigure() {
			this.setText("Filter");
		}
