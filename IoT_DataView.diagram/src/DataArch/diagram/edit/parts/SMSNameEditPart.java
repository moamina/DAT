 ...
 * @generated
 */
public class SMSNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.SMSNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public SMSNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.SMS_3016, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new SMSLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SMSLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SMSLabelFigure() {
			this.setText("SMS");
		}
