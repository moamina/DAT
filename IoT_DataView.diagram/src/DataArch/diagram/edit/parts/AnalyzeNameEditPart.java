 ...
 * @generated
 */
public class AnalyzeNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.AnalyzeNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public AnalyzeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Analyze_3059, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new AnalyzeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AnalyzeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AnalyzeLabelFigure() {
