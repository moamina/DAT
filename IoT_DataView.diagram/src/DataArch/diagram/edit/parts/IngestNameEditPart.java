 ...
 * @generated
 */
public class IngestNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.IngestNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public IngestNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Ingest_3062, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new IngestLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IngestLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public IngestLabelFigure() {
			this.setText("Ingest");
		}
