 ...
 * @generated
 */
public class CSVNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.CSVNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public CSVNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.CSV_3011, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new CSVLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CSVLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CSVLabelFigure() {
			this.setText("CSV");
		}
