 ...
 * @generated
 */
public class ProcessNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.ProcessNameEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ProcessLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ProcessLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ProcessLabelFigure() {
