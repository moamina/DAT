 ...
 * @generated
 */
public class AggregateNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.AggregateNameEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AggregateLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AggregateLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AggregateLabelFigure() {
			this.setText("Aggregate");
		}
