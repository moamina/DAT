 ...
 * @generated
 */
public class ReduceNoiseNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.ReduceNoiseNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public ReduceNoiseNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ReduceNoiseLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ReduceNoiseLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ReduceNoiseLabelFigure() {
			this.setText("ReduceNoise");
		}
