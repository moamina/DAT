 ...
 * @generated
 */
public class MergeNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.MergeNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public MergeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new MergeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class MergeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public MergeLabelFigure() {
			this.setText("Merge");
		}
