 ...
 * @generated
 */
public class ColumnOrientedNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.ColumnOrientedNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public ColumnOrientedNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.ColumnOriented_3021, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new ColumnOrientedLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ColumnOrientedLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ColumnOrientedLabelFigure() {
			this.setText("ColumnOriented");
		}
