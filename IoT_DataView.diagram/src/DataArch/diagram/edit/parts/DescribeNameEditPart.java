 ...
 * @generated
 */
public class DescribeNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.DescribeNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public DescribeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new DescribeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class DescribeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public DescribeLabelFigure() {
			this.setText("Describe");
		}
