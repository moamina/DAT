 ...
 * @generated
 */
public class ConnectionTextEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.ConnectionTextEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public ConnectionTextEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Connection_4002, getParserElement(),
