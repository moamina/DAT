 ...
 * @generated
 */
public class ReceiveDataNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.ReceiveDataNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public ReceiveDataNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.ReceiveData_3053, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new ReceiveDataLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ReceiveDataLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ReceiveDataLabelFigure() {
			this.setText("ReceiveData");
		}
