 ...
 * @generated
 */
public class IntegrateNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.IntegrateNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public IntegrateNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Integrate_3039, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new IntegrateLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IntegrateLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public IntegrateLabelFigure() {
			this.setText("Integrate");
		}
