 ...
 * @generated
 */
public class ValidateNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.ValidateNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public ValidateNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Validate_3041, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new ValidateLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ValidateLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ValidateLabelFigure() {
