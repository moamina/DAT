 ...
 * @generated
 */
public class Math_OperationNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.Math_OperationNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public Math_OperationNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new Math_OperationLabelFigure();
	}

	/**
	 * @generated
	 */
	public class Math_OperationLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public Math_OperationLabelFigure() {
			this.setText("Math_Operation");
		}
