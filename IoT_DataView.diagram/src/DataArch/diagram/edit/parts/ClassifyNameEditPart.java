 ...
 * @generated
 */
public class ClassifyNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.ClassifyNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public ClassifyNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Classify_3042, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new ClassifyLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ClassifyLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ClassifyLabelFigure() {
			this.setText("Classify");
		}
