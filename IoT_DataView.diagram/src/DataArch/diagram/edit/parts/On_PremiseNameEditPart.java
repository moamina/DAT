 ...
 * @generated
 */
public class On_PremiseNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.On_PremiseNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public On_PremiseNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new On_PremiseLabelFigure();
	}

	/**
	 * @generated
	 */
	public class On_PremiseLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public On_PremiseLabelFigure() {
			this.setText("On_Premise");
		}
