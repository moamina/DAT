 ...
 * @generated
 */
public class KeyValueNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.KeyValueNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public KeyValueNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.KeyValue_3023, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new KeyValueLabelFigure();
	}

	/**
	 * @generated
	 */
	public class KeyValueLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public KeyValueLabelFigure() {
			this.setText("KeyValue");
		}
