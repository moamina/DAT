 ...
 * @generated
 */
public class IdentifyNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.IdentifyNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public IdentifyNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Identify_3042, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new IdentifyLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IdentifyLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public IdentifyLabelFigure() {
			this.setText("Identify");
		}
