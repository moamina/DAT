 ...
 * @generated
 */
public class ImageNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.ImageNameEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Image_3003, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new ImageLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ImageLabelFigure extends WrappingLabel {
