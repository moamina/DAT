 ...
 * @generated
 */
public class VerifyDataNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.VerifyDataNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public VerifyDataNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.VerifyData_3061, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new VerifyDataLabelFigure();
	}

	/**
	 * @generated
	 */
	public class VerifyDataLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public VerifyDataLabelFigure() {
			this.setText("VerifyData");
		}
