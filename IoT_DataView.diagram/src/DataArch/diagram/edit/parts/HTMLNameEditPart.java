 ...
 * @generated
 */
public class HTMLNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.HTMLNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public HTMLNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.HTML_3013, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new HTMLLabelFigure();
	}

	/**
	 * @generated
	 */
	public class HTMLLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public HTMLLabelFigure() {
			this.setText("HTML");
		}
