 ...
 * @generated
 */
public class VisualizeNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.VisualizeNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public VisualizeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Visualize_3036, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new VisualizeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class VisualizeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public VisualizeLabelFigure() {
			this.setText("Visualize");
		}
