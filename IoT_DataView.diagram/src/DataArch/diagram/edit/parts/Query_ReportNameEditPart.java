 ...
 * @generated
 */
public class Query_ReportNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.Query_ReportNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public Query_ReportNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new Query_ReportLabelFigure();
	}

	/**
	 * @generated
	 */
	public class Query_ReportLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public Query_ReportLabelFigure() {
			this.setText("Query_Report");
		}
