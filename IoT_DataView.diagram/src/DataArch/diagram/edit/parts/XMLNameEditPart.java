 ...
 * @generated
 */
public class XMLNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.XMLNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public XMLNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.XML_3009, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new XMLLabelFigure();
	}

	/**
	 * @generated
	 */
	public class XMLLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public XMLLabelFigure() {
			this.setText("XML");
		}
