 ...
 * @generated
 */
public class SaveNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.SaveNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public SaveNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SaveLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SaveLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SaveLabelFigure() {
			this.setText("Save");
		}
