 ...
 * @generated
 */
public class RDFNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.RDFNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public RDFNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.RDF_3014, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new RDFLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RDFLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RDFLabelFigure() {
			this.setText("RDF");
		}
