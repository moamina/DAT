 ...
 * @generated
 */
public class DiagnoseNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.DiagnoseNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public DiagnoseNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Diagnose_3031, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new DiagnoseLabelFigure();
	}

	/**
	 * @generated
	 */
	public class DiagnoseLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public DiagnoseLabelFigure() {
			this.setText("Diagnose");
		}
