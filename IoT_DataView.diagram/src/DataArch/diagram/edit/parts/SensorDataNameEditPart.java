 ...
 * @generated
 */
public class SensorDataNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.SensorDataNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public SensorDataNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.SensorData_3019, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new SensorDataLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SensorDataLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SensorDataLabelFigure() {
			this.setText("SensorData");
		}
