 ...
 * @generated
 */
public class GPSDataNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.GPSDataNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public GPSDataNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.GPSData_3018, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new GPSDataLabelFigure();
	}

	/**
	 * @generated
	 */
	public class GPSDataLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public GPSDataLabelFigure() {
			this.setText("GPSData");
		}
