 ...
 * @generated
 */
public class BatchNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.BatchNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public BatchNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new BatchLabelFigure();
	}

	/**
	 * @generated
	 */
	public class BatchLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public BatchLabelFigure() {
			this.setText("Batch");
		}
