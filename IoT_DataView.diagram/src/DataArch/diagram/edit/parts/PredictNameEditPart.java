 ...
 * @generated
 */
public class PredictNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.PredictNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public PredictNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Predict_3032, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new PredictLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PredictLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PredictLabelFigure() {
			this.setText("Predict");
		}
