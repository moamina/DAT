 ...
 * @generated
 */
public class GraphsDatabaseNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.GraphsDatabaseNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public GraphsDatabaseNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.GraphsDatabase_3022, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new GraphsDatabaseLabelFigure();
	}

	/**
	 * @generated
	 */
	public class GraphsDatabaseLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public GraphsDatabaseLabelFigure() {
			this.setText("GraphsDatabase");
		}
