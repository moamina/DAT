 ...
 * @generated
 */
public class GovernNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.GovernNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public GovernNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Govern_3052, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new GovernLabelFigure();
	}

	/**
	 * @generated
	 */
	public class GovernLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public GovernLabelFigure() {
			this.setText("Govern");
		}
