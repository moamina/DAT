 ...
 * @generated
 */
public class ArchiveNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.ArchiveNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public ArchiveNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Archive_3053, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new ArchiveLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ArchiveLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ArchiveLabelFigure() {
			this.setText("Archive");
		}
