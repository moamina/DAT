 ...
 * @generated
 */
public class LogsNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.LogsNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public LogsNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Logs_3004, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new LogsLabelFigure();
	}

	/**
	 * @generated
	 */
	public class LogsLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public LogsLabelFigure() {
			this.setText("Logs");
		}
