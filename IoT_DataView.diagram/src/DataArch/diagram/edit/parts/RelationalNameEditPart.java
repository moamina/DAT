 ...
 * @generated
 */
public class RelationalNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.RelationalNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public RelationalNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new RelationalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RelationalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RelationalLabelFigure() {
			this.setText("Relational");
		}
