 ...
 * @generated
 */
public class DataArchitectureEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "DataArch"; //$NON-NLS-1$
	...
	* @generated
	*/
	public DataArchitectureEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DataArch.diagram.edit.policies.DataArchitectureItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new DataArch.diagram.edit.policies.DataArchitectureCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new DataArch.diagram.edit.commands.DataArchCreateShortcutDecorationsCommand(
