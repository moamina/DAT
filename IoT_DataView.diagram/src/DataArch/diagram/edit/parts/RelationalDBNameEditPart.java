 ...
 * @generated
 */
public class RelationalDBNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.RelationalDBNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public RelationalDBNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.RelationalDB_3008, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new RelationalDBLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RelationalDBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RelationalDBLabelFigure() {
			this.setText("RelationalDB");
		}
