 ...
 * @generated
 */
public class TextFileNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.TextFileNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public TextFileNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.TextFile_3007, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new TextFileLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TextFileLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TextFileLabelFigure() {
			this.setText("TextFile");
		}
