 ...
 * @generated
 */
public class AudioNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.AudioNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public AudioNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Audio_3001, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new AudioLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AudioLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AudioLabelFigure() {
			this.setText("Audio");
		}
