 ...
 * @generated
 */
public class VideoNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.VideoNameEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Video_3002, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new VideoLabelFigure();
	}

	/**
	 * @generated
	 */
	public class VideoLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public VideoLabelFigure() {
			this.setText("Video");
		}
