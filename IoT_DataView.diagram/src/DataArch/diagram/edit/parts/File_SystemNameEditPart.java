 ...
 * @generated
 */
public class File_SystemNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.File_SystemNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public File_SystemNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new File_SystemLabelFigure();
	}

	/**
	 * @generated
	 */
	public class File_SystemLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public File_SystemLabelFigure() {
			this.setText("File_System");
		}
