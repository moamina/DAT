 ...
 * @generated
 */
public class TranfromNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.TranfromNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public TranfromNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Tranfrom_3037, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new TranfromLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TranfromLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TranfromLabelFigure() {
			this.setText("Tranfrom");
		}
