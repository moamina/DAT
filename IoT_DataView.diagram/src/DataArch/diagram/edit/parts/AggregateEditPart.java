...
public class AggregateEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DataArch.diagram.edit.policies.AggregateItemSemanticEditPolicy());
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof DataArch.diagram.edit.parts.AggregateNameEditPart) {
	...
	*/
	 ...
	 * @generated
	 */
	public class AggregateFigure extends iot_DataView.figures.AggregateFigure {
