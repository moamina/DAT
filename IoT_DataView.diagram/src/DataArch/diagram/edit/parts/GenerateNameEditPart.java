 ...
 * @generated
 */
public class GenerateNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.GenerateNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public GenerateNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Generate_3057, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new GenerateLabelFigure();
	}

	/**
	 * @generated
	 */
	public class GenerateLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public GenerateLabelFigure() {
