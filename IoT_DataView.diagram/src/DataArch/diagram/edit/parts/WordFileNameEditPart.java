 ...
 * @generated
 */
public class WordFileNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.WordFileNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public WordFileNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.WordFile_3005, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new WordFileLabelFigure();
	}

	/**
	 * @generated
	 */
	public class WordFileLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public WordFileLabelFigure() {
			this.setText("WordFile");
		}
