 ...
 * @generated
 */
public class ExcelNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.ExcelNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public ExcelNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataArch.diagram.providers.DataArchParserProvider.getParser(
					DataArch.diagram.providers.DataArchElementTypes.Excel_3012, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new ExcelLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ExcelLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ExcelLabelFigure() {
			this.setText("Excel");
		}
