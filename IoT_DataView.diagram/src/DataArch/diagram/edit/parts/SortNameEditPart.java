 ...
 * @generated
 */
public class SortNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.SortNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public SortNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SortLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SortLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SortLabelFigure() {
			this.setText("Sort");
		}
