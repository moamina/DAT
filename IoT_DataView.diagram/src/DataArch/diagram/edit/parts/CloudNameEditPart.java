 ...
 * @generated
 */
public class CloudNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataArch.diagram.part.DataArchVisualIDRegistry
				.getType(DataArch.diagram.edit.parts.CloudNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public CloudNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new CloudLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CloudLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CloudLabelFigure() {
			this.setText("Cloud");
		}
