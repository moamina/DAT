 ...
 * @generated
 */
public class DataNodeCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DataArch.DataArchPackage.eINSTANCE.getDataNode_Ports();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DataArch.diagram.part.DataArchNodeDescriptor> childDescriptors = DataArch.diagram.part.DataArchDiagramUpdater
				.getDataNode_2001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == DataArch.diagram.edit.parts.InMessagePortEditPart.VISUAL_ID
				|| visualID == DataArch.diagram.edit.parts.OutMessagePortEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DataArch.diagram.part.DataArchNodeDescriptor> childDescriptors = DataArch.diagram.part.DataArchDiagramUpdater
				.getDataNode_2001SemanticChildren((View) getHost().getModel());
