 ...
 * @generated
 */
public class DataArchModelingAssistantProviderOfSendDataEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((DataArch.diagram.edit.parts.SendDataEditPart) sourceEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSource(DataArch.diagram.edit.parts.SendDataEditPart source) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((DataArch.diagram.edit.parts.SendDataEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(DataArch.diagram.edit.parts.SendDataEditPart source,
		...
		if (targetEditPart instanceof DataArch.diagram.edit.parts.OutMessagePortEditPart) {
			types.add(DataArch.diagram.providers.DataArchElementTypes.SendDataToMessagePorts_4004);
		}
		return types;
	}
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((DataArch.diagram.edit.parts.SendDataEditPart) sourceEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(DataArch.diagram.edit.parts.SendDataEditPart source,
		...
		if (relationshipType == DataArch.diagram.providers.DataArchElementTypes.Link_4001) {
			...
			types.add(DataArch.diagram.providers.DataArchElementTypes.Cloud_3060);
			types.add(DataArch.diagram.providers.DataArchElementTypes.On_Premise_3061);
			types.add(DataArch.diagram.providers.DataArchElementTypes.File_System_3024);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Relational_3025);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Multidimensional_3026);
			types.add(DataArch.diagram.providers.DataArchElementTypes.RealTime_3027);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Batch_3028);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Filter_3029);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Describe_3030);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Diagnose_3031);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Predict_3032);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Prescript_3033);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Visualize_3034);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Query_Report_3035);
			types.add(DataArch.diagram.providers.DataArchElementTypes.API_3036);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Tranfrom_3037);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Compress_3038);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Integrate_3039);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Identify_3040);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Validate_3041);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Classify_3042);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Sort_3043);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Merge_3044);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Aggregate_3045);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Cleaning_3046);
			types.add(DataArch.diagram.providers.DataArchElementTypes.ReduceNoise_3047);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Math_Operation_3048);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Retrieve_3049);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Save_3050);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Archive_3051);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Govern_3052);
			types.add(DataArch.diagram.providers.DataArchElementTypes.SendData_3054);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Generate_3055);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Ingest_3062);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Analyze_3056);
			types.add(DataArch.diagram.providers.DataArchElementTypes.Process_3057);
		} else if (relationshipType == DataArch.diagram.providers.DataArchElementTypes.SendDataToMessagePorts_4004) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((DataArch.diagram.edit.parts.SendDataEditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(DataArch.diagram.edit.parts.SendDataEditPart target) {
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((DataArch.diagram.edit.parts.SendDataEditPart) targetEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(DataArch.diagram.edit.parts.SendDataEditPart target,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == DataArch.diagram.providers.DataArchElementTypes.Link_4001) {
			types.add(DataArch.diagram.providers.DataArchElementTypes.Audio_3001);
