 ...
 * @generated
 */
public class DataArchShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = DataArch.diagram.part.DataArchDiagramEditorPlugin.getInstance()
