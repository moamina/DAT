 ...
 * @generated
 */
public class DataArchMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = DataArch.diagram.part.DataArchDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			DataArch.diagram.part.DataArchDiagramEditorUtil.selectElementsInDiagram(editor,
