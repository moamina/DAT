 ...
 * 
 */
package DataArch.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(DataArch.diagram.part.DataArchDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(DataArch.diagram.part.Messages.MessageFormatParser_InvalidInputError,
