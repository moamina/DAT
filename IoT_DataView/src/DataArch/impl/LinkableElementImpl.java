 ...
 * </p>
 * <ul>
 *   <li>{@link DataArch.impl.LinkableElementImpl#getOutgoing <em>Outgoing</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class LinkableElementImpl extends BehaviouralElementImpl implements LinkableElement {
	...
	protected EClass eStaticClass() {
		return DataArchPackage.Literals.LINKABLE_ELEMENT;
	}
	...
	public EList<Link> getOutgoing() {
		if (outgoing == null) {
			outgoing = new EObjectWithInverseResolvingEList<Link>(Link.class, this, DataArchPackage.LINKABLE_ELEMENT__OUTGOING, DataArchPackage.LINK__SOURCE);
		}
		return outgoing;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataArchPackage.LINKABLE_ELEMENT__OUTGOING:
